...
BYDOM.getClassName = function (className, parent) {
  ...
  * 判断某节点是否是某节点的子节点
  */
 BYDOM.contains = function (refNode, otherNode) {
  ...
  */
 BYDOM.getInnerText = function (element) {
  ...
  * 设置text
  */
 BYDOM.setInnerText = function (element, text) {
  ...
  * 判断一个元素是否包含一个类
  */
 BYDOM.hasClass = function (element, className) {
  ...
  * 添加一个类
  */
 BYDOM.addClass = function (element, className) {
  ...
  * 移除一个类
  */
 BYDOM.removeClass = function (element, className) {
	if(this.hasClass(element, className)) {
  ...
  * 获取HTMLLinkElement
  */
 BYDOM.styleSheet = function (index) {
  ...
  * @param position 位置
  */
 BYDOM.insertRule = function (sheet, selectorText, cssText, position) {
	// 非IE
	if(sheet.insertRule) {
  ...
  * @param index 位置
  */
 BYDOM.deleteRule = function (sheet, index) {
	// 非IE
	if(sheet.deleteRule) {
  ...
  * 获取元素的样式
  */
 BYDOM.getStyle = function (element, name) {
  ...
  * 距离左上角的left
  */
 BYDOM.offsetLeft = function (element) {
 ...
 * 滚动条置顶
 */
 BYDOM.scrollStart = function (element) {
  ...
  * 获取DOM元素的位置
  */
 BYDOM.getRect = function (element) {
  ...
  */
 BYDOM.getCharCode = function (evt) {
	var e = this.getEvt(evt);
  ...
  * 阻止向上的冒泡行为
  */
 BYDOM.stopPropagation = function (evt) {
	var e = this.getEvt(evt);
  ...
  * 阻止事件的默认行为
  */
 BYDOM.preventDefault = function (evt) {
	var e = this.getEvt(evt);
	if(e.preventDefault) {
		e.preventDefault();
	} else {
  ...
  */
 BYDOM.addEvent = function (obj, type, fn, useCapture) {
  ...
  * 判断是否已经添加过fn
  */
 BYDOM.__fnExisted = function (obj, type, fn) {
  ...
  * 判断有名称的函数组中是否包含fn函数
  */
 BYDOM.__hasNameFnExisted = function (fns, fn) {
  ...
  * 判断匿名函数组中是否包含fn函数
  */
 BYDOM.__noNameFnExisted = function (fns, fn) {
	for(var i = 0, max = fns.length; i < max; i++) {
  ...
  * 批量执行绑定的事件
  */
 BYDOM.__execEventHandlers = function (evt) {
 ...
 * 选择部分文本实现跨浏览器兼容
 */
BYDOM.selectText = function (text, start, stop) {
 ...
 */
 ...
 var BYCookies = Global('Cookies.BY');
 
 /**
  * 设置cookie
  */
 BYCookies.setCookie = function (name, value, expires, path, domain, secure) {
  ...
  * 获取cookie
  */
 BYCookies.getCookie = function (name) {
  ...
  * 失效cookie
  */
 BYCookie.unsetCookie = function (name) {
